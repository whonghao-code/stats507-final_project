...
# Prediction and indicator calculation
y_pred = xgb_model.predict(X_test_tfidf)
accuracy = accuracy_score(y_test, y_pred)
weighted_f1 = f1_score(y_test, y_pred, average="weighted")


print("dair-ai/emotion Text multi-class classification results（XGBoost+TF-IDF）")
...
ax.set_title("Confusion Matrix using TF-IDF+XGBoost", fontsize=20, fontweight='bold', pad=20)
...
plt.tight_layout()
plt.savefig("./visualizations/original_data_confusion_matrix_xgb.png", dpi=300, bbox_inches="tight")